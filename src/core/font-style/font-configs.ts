...
export const familiasDisponibles = [
  ...
  },
  {
    ...
    propiedades: [
      ...
      italicConfig(false),
      createFontVariationAxe([
        { variation: fontVariations.softness, min: 0, max: 100, step: 2, initialValue: 0 },
...

  {
    ...
    propiedades: [
      ...
      createFontVariationAxe([
        ...
        { variation: fontVariations.thickStroke, min: 27, max: 175, step: 2, initialValue: 96 },
        { variation: fontVariations.thinStroke, min: 25, max: 135, step: 2, initialValue: 79 },
        { variation: fontVariations.figureHeight, min: 560, max: 788, step: 2, initialValue: 738 },
      ]),
    ],
  },
] as fontFamily[];
