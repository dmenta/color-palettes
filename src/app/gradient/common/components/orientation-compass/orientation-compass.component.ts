...
import { GradientOrientationState, GRADIENT_ORIENTATION_TOKEN } from "../../models/gradient-state.model";
import { Point, pointsMatch } from "../../models/point.model";
import { domCommon } from "../../common-funcs";
...
export class OrientationCompassComponent {
  ...
  private state: GradientOrientationState = inject(GRADIENT_ORIENTATION_TOKEN);
