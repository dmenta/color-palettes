...
export const bezierCurve = {
  points: beziersPoints,
  doublePoints: beziersDoublePoints,
};

function beziersPoints(
  coords: Handlers,
  sizeX: number,
  sizeY: number,
...
function beziersDoublePoints(coords: DoubleHandlers, center: Point, virtualSize: number) {
